...
def main(cfg):
    ...
    generate_rd_for_dir(evaluation_perquery_dir, rd_absolute_perquery_dir, cfg.dtc.n_evee)
    generate_rd_for_dir(evaluation_mean_dir, rd_absolute_mean_dir, cfg.dtc.n_evee)
